...
main() {
    ...
    prefix-rewrite-example)
        ...
        ;;
    priority-example)
        ./mesh/mesh.sh restore-routes
        update_gateway_route "${TEST_MESH_DIR}/colorgateway-route-updated-6.1.json" "colorgateway-vg" "colorgateway-route-1" "colorteller-1.${SERVICES_DOMAIN}"
        update_gateway_route "${TEST_MESH_DIR}/colorgateway-route-updated-6.2.json" "colorgateway-vg" "colorgateway-route-2" "colorteller-2.${SERVICES_DOMAIN}"
        ;;
    priority-example-reverse-priority)
        update_gateway_route "${TEST_MESH_DIR}/colorgateway-route-updated-6.3.json" "colorgateway-vg" "colorgateway-route-1" "colorteller-1.${SERVICES_DOMAIN}"
        update_gateway_route "${TEST_MESH_DIR}/colorgateway-route-updated-6.4.json" "colorgateway-vg" "colorgateway-route-2" "colorteller-2.${SERVICES_DOMAIN}"
        ;;
    method-match-example)
        update_gateway_route "${TEST_MESH_DIR}/colorgateway-route-updated-8.1.json" "colorgateway-vg" "colorgateway-route-1" "colorteller-1.${SERVICES_DOMAIN}"
        update_gateway_route "${TEST_MESH_DIR}/colorgateway-route-updated-8.2.json" "colorgateway-vg" "colorgateway-route-2" "colorteller-2.${SERVICES_DOMAIN}"
        ;;
    prefix-rewrite-default-example-disabled)
        update_gateway_route "${TEST_MESH_DIR}/colorgateway-route-updated-9.1.json" "colorgateway-vg" "colorgateway-route-1" "colorteller-1.${SERVICES_DOMAIN}"
        update_route "${TEST_MESH_DIR}/colorteller-route-update-2.json" "colorteller-vr-1" "colorteller-route-1"
        ;;
    prefix-rewrite-default-example-enabled)
        update_gateway_route "${TEST_MESH_DIR}/colorgateway-route-updated-9.2.json" "colorgateway-vg" "colorgateway-route-1" "colorteller-1.${SERVICES_DOMAIN}"
        update_route "${TEST_MESH_DIR}/colorteller-route-update-2.json" "colorteller-vr-1" "colorteller-route-1"
        ;;
    restore-routes)
        update_route "${TEST_MESH_DIR}/colorteller-route-1.json" "colorteller-vr-1" "colorteller-route-1"
        update_route "${TEST_MESH_DIR}/colorteller-route-2.json" "colorteller-vr-2" "colorteller-route-2"
    ;;
    down)
